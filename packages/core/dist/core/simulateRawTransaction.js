...
async function simulateRawTransaction(connection, rawTransaction, includeAccounts) {
     ...
     */
    const simulated = await web3_js_1.Connection.prototype.simulateTransaction.call(connection, web3_js_1.Transaction.from(rawTransaction), undefined, includeAccounts);
